...
function TeacherDashboardWithUid() {
  const { profile, uid, loading } = useAuth();
      ...
      <Router>
        <Layout>
          <Routes>
            ...
            <Route path="/teacher/AddQuize" element={<AddQuizPage />} />
            <Route path="/teacher/AddLiveSessions" element={<AddLiveSession />} />
            <Route path="/teacher/report" element={<ReportsPage />} />
