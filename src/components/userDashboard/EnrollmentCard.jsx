...
export default function EnrollmentCard({ enrollment, course }) {
  ...
  return (
    <Card className="flex items-center gap-4 relative p-4">
      {/* Status badge */}
      <div
    ...
    ${enrollment.status === "completed" ? "bg-[#0E7C7B] text-white" :
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="text-sm text-muted-foreground text-[#0E7C7B] mt-2">
        ...
        {/* Action button */}
        <Button
          className="btn-primary w-auto py-2 px-4 text-sm mt-3"
      ...
      {/* Enrollment info */}
      <div className="absolute bottom-4 right-4 text-xs text-gray-400 text-right space-y-1">
