      ...
      <table className="min-w-full divide-y divide-gray-200 mt-6 border border-rounded-xlg overflow-hidden text-sm">
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {filteredUsers.map((user) => (
            <tr key={user.id}>
              <td className="p-2 whitespace-nowrap">{user.fullname}</td>
              ...
              <td className="p-2 whitespace-nowrap">{user.progress || 0}</td>
              <td className="p-2 whitespace-nowrap">
                <span
                  className={`rounded-2xl px-3 py-1 text-xs ${user.status
